...
function Signup() {
    return (
        <>
            ...
            <div className=" my-20">
                <h1 className="text-4xl my-6 text-white text-center">Sign up</h1>
                ...
                <h1 className="text-gray-400 text-center my-6"> Already signup  <Link className="text-blue-500" to ="/signin">Log in</Link> then</h1>
