...
function Login() {
    return (
        <>
            <div className=" my-20">
                <h1 className="text-4xl my-6 text-white text-center">Sign in</h1>
                <form className="max-w-md mx-auto">
                    ...
                    <h1 className="text-gray-400 text-center my-6"> Click here to <Link className="text-blue-500" to ="/signup">Sign up</Link></h1>
                </form>
            </div>
        </>
    )
